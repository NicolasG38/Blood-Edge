...
insert into Nano_suits (NS_id, NS_title, NS_text, NS_text_2, NS_Where_title, NS_Where_text, NS_picture, NS_Stars)
values
    (1, "Alice ensoleillée", "Permet de modifier l'apparence d'EVE", "Découvrez la collection de maillots de bain ensoleillée de Tetrastar C&T: partez en vacances au Pays des merveilles !", "Où la trouver ?", "Dans la boutique Tetrastar C&T", "/images/nano_suits/Alice_ensoleillee.webp", "/icons/star_fill_blue.webp"),
    (2, "Aventurière des terres désolée", "Permet de modifier l'apparence d'EVE", "Personne ne peut vous arrêter, Traversez les zones hostiles et franchissez les obstacles avec la tenue Aventurière. Bien entendu, n'allez pas chercher de poux dans la tête des Naytibas.", "Où la trouver ?", "Dans la boutique Tetrastar C&T", "/images/nano_suits/Aventuriere_des_terres_desolee.webp", "/icons/star_fill_blue.webp"),
